...
enum class MessageType : uint16_t {
  ...
  M_CIRCUITPLAYGROUND_SET_PIXEL = 0x0C02,
  M_CIRCUITPLAYGROUND_SET_BRIGHTNESS = 0x0C03,
  M_CIRCUITPLAYGROUND_BUTTONS = 0x0C04,
  M_CIRCUITPLAYGROUND_CAPTOUCH = 0x0C05,
  M_CIRCUITPLAYGROUND_ACCELEROMETER = 0x0C06,
  M_CIRCUITPLAYGROUND_TEMPERATURE = 0x0C07,
  M_CIRCUITPLAYGROUND_LIGHT = 0x0C08,
  M_CIRCUITPLAYGROUND_SOUND = 0x0C09,
